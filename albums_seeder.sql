...
values('Michael Jackson ', 'Thriller ', 1982, 50.2, 'Pop, post-disco, funk, rock '),
       ...
       ('Led Zeppelin ','Led Zeppelin ', 1971, 29.0 ,'Hard rock, heavy metal, folk rock ' ),
       ...
       ('ABBA ','Gold: Greatest Hits ', 1882, 23.0, 'Pop, disco'),
       ('Guns N'' Roses ','Appetite for Destruction ', 1987, 21.9, 'Hard rock ' ),
       ('Michael Jackson ', 'Bad ', 1997, 21.1, 'Pop, rhythm and blues, funk and rock ' ),
       ...
       ('James Horner ', 'Titanic: Music from the Motion Picture ', 1997, 18.2, 'Film score '),
